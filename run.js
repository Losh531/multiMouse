...
// const multiplayer = require("./code/server/multiplayer");
let multiplayer;
const loadMultiplayer = async() => {
  if (multiplayer) return multiplayer;
  multiplayer = await import("./code/server/multiplayer.mjs");
...
function buildGame() {
	...
	try {
		...
		esbuild.buildSync({
			...
			keepNames: true,
			logLevel: "silent",
			entryPoints: ["code/client/main.js"],
